...
import sample.cafediosk.spring.api.service.order.request.OrderCreateServiceRequest;
...
import sample.cafediosk.spring.domain.stock.Stock;
import sample.cafediosk.spring.domain.stock.StockRepository;
