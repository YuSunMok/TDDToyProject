package sample.cafediosk.spring.domain.product;
...
class ProductRepositoryTest {
    ...
    @Test
    @DisplayName("가장 마지막으로 저장항 상품 번호를 읽어온다.")
    ...
    @Test
    @DisplayName("가장 마지막으로 저장항 상품 번호를 읽어올 때, 상품이 하나도 없는 경우에는 null을 반환한다.")
    public void findLatestProductNumberIsEmpty() {
        // given
